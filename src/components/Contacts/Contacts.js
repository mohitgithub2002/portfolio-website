...
import { FaFacebook,FaInstagram, FaGithub, FaLinkedinIn, FaMediumM, FaStackOverflow, FaTwitter } from 'react-icons/fa';
            ...
            <div className={styles.contactsContainer}>
                ...
                <div className={styles.contactsBody}>
                    ...
                    <div className={styles.contactsDetails}>
                        ...
                        >
                            <div className="w-[45px] h-[45px] rounded-[50%] flex items-center justify-center text-2xl transition ease-in-out text-[#15202B] bg-[#8B98A5] hover:bg-[#1D9BF0] hover:scale-[1.1] shrink delay-200"
                            >
                                <FiAtSign />
                            </div>
                        ...
                        <div className={styles.socialmediaIcons}>
                            {socialsData.twitter && (
                                <a
                                    ...
                                    target='_blank'
                                    rel='noreferrer'
                                    className="w-[45px] h-[45px] rounded-[50%] flex items-center justify-center text-xl transition ease-in-out text-[#15202B] bg-[#8B98A5] hover:bg-[#1D9BF0]"
                                >
